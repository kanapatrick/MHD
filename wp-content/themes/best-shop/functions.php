...
if($pagenow == 'index.php' || $pagenow == 'themes.php'){
    ...
    if ( isset( $_GET['hide_admin_notice'] ) ) {
         update_option('best_shop_hide_admin_notice', 'feb-dismiss-notice');
    } else {
        $best_shop_notice = get_option('best_shop_hide_admin_notice', '');
        if ($best_shop_notice != 'feb-dismiss-notice' || $best_shop_notice == '') {	
...
function best_shop_admin_notice_info() {
    ...
    $tutorial = __( 'How to build my business? / Upgrade to PRO', 'best-shop');
