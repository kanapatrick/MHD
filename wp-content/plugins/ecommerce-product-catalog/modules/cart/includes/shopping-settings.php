	...
	if ( $submenu == 'shopping-cart' ) {
        ...
        <div class="shopping-cart-settings setting-content submenu">
            <form method="post" action="options.php">
                ...
                <table>
                    <tr>
                        ...
                        <td>
							...
							ic_select_page( 'shopping_cart_settings[shopping_cart_page]', __( 'Select Cart Page', 'ecommerce-product-catalog' ), $shopping_cart_settings['shopping_cart_page'], true, false, 1, false, '', array( 'title'      => __( 'Cart', 'ecommerce-product-catalog' ),
                    ...
                    <tr>
                        ...
                        <td>
							...
							ic_select_page( 'shopping_cart_settings[cart_submit_page]', __( 'Select Submit Page', 'ecommerce-product-catalog' ), $shopping_cart_settings['cart_submit_page'], true, false, 1, false, '', array( 'title'      => __( 'Checkout', 'ecommerce-product-catalog' ),
							                                                                                                                                                                                                    'content'    => $default_content,
							                                                                                                                                                                                                    'option'     => 'shopping_cart_settings',
                    ...
                    <tr>
                        ...
                        <td>
							...
							ic_select_page( 'shopping_cart_settings[thank_you_page]', __( 'Select Thank You Page', 'ecommerce-product-catalog' ), $shopping_cart_settings['thank_you_page'], true, false, 1, false, '', array( 'title'      => __( 'Thank You', 'ecommerce-product-catalog' ),
							                                                                                                                                                                                                   'content'    => $default_content,
							                                                                                                                                                                                                   'option'     => 'shopping_cart_settings',
                ...
                <table><?php
					implecode_settings_radio( __( 'Remember fields by', 'ecommerce-product-catalog' ), 'shopping_cart_settings[form_registration]', $shopping_cart_settings['form_registration'], array( 'user'   => __( 'User Account', 'ecommerce-product-catalog' ),
...
//$default = '{"fields":[{"label":"Name","field_type":"text","required":true,"field_options":{"size":"medium"},"cid":"name"},{"label":"Email","field_type":"email","required":true,"field_options":{"size":"medium"},"cid":"email"},{"label":"Subject","field_type":"text","required":true,"field_options":{"size":"medium"},"cid":"subject"},{"label":"Message","field_type":"paragraph","required":true,"field_options":{"size":"medium"},"cid":"message"}]}';
	...
	$default .= '},"cid":"country"}';
	if ( empty( $shopping_cart_settings['disable_state'] ) ) {
		$default .= ',{"label":"' . __( 'State', 'ecommerce-product-catalog' ) . ':","field_type":"dropdown","required":true,"field_options":{"size":"medium","paypal":"customer_state"';
		$default .= ',"options":[';
